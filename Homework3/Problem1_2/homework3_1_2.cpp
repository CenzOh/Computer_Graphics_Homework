...
void drawLeaf()
{
	c += 0.000085; //acounting for the image being redrawn for some reason
	glColor3f(0+c, 1, 0); //green
	glPointSize(8);
	glBegin(GL_POINTS); //square point
...
{
	CP.set(0, 0);
	glClearColor(0.5, 0.5, 1.0, 0.3); //background color, light blue
...
void main(int argc, char** argv)
{
	...
	glutCreateWindow("L-System Tree 3_1_2"); // open the screen window and set the name
